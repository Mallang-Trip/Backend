package mallang_trip.backend.domains.destination.controller;

import static mallang_trip.backend.domains.destination.constant.DestinationType.BY_ADMIN;
import static mallang_trip.backend.domains.destination.constant.DestinationType.BY_USER;
...
import mallang_trip.backend.domains.destination.service.DestinationDibsService;
import mallang_trip.backend.domains.destination.service.DestinationReviewService;
import mallang_trip.backend.domains.destination.service.DestinationService;
