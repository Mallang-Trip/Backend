package mallang_trip.backend.domains.driver.service;

import static mallang_trip.backend.domains.driver.constant.DriverStatus.ACCEPTED;
import static mallang_trip.backend.domains.driver.constant.DriverStatus.CANCELED;
import static mallang_trip.backend.domains.driver.constant.DriverStatus.REFUSED;
import static mallang_trip.backend.domains.driver.constant.DriverStatus.WAITING;
...
import mallang_trip.backend.domains.driver.repository.DriverPriceRepository;
...
import mallang_trip.backend.domains.driver.dto.ChangeDriverProfileRequest;
import mallang_trip.backend.domains.driver.dto.DriverBriefResponse;
import mallang_trip.backend.domains.driver.dto.DriverDetailsResponse;
import mallang_trip.backend.domains.driver.dto.DriverPriceRequest;
import mallang_trip.backend.domains.driver.dto.DriverPriceResponse;
import mallang_trip.backend.domains.driver.dto.DriverRegistrationRequest;
import mallang_trip.backend.domains.driver.dto.DriverRegistrationResponse;
import mallang_trip.backend.domains.driver.dto.MyDriverProfileResponse;
