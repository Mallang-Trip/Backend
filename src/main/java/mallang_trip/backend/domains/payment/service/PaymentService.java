package mallang_trip.backend.domains.payment.service;

import static mallang_trip.backend.domains.reservation.constant.ReservationStatus.PAYMENT_COMPLETE;
import static mallang_trip.backend.domains.reservation.constant.ReservationStatus.PAYMENT_REQUIRED;
import static mallang_trip.backend.domains.reservation.constant.ReservationStatus.REFUND_COMPLETE;
import static mallang_trip.backend.domains.reservation.constant.ReservationStatus.REFUND_FAILED;
...
import mallang_trip.backend.domains.payment.dto.CardResponse;
import mallang_trip.backend.domains.payment.dto.BillingKeyResponse;
import mallang_trip.backend.domains.payment.dto.PaymentRequest;
import mallang_trip.backend.domains.payment.dto.PaymentResponse;
import mallang_trip.backend.domains.payment.entity.Card;
import mallang_trip.backend.domains.payment.entity.Payment;
import mallang_trip.backend.domains.payment.repository.CardRepository;
import mallang_trip.backend.domains.payment.repository.PaymentRepository;
