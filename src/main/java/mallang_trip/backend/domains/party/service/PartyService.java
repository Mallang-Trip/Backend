...
import static mallang_trip.backend.domains.party.constant.PartyStatus.CANCELED_BY_ALL_QUIT;
import static mallang_trip.backend.domains.party.constant.PartyStatus.CANCELED_BY_DRIVER_QUIT;
import static mallang_trip.backend.domains.party.constant.PartyStatus.CANCELED_BY_DRIVER_REFUSED;
import static mallang_trip.backend.domains.party.constant.PartyStatus.CANCELED_BY_PROPOSER;
...
import static mallang_trip.backend.domains.party.constant.PartyStatus.WAITING_DRIVER_APPROVAL;
...
import static mallang_trip.backend.domains.global.io.BaseResponseStatus.ALREADY_PARTY_MEMBER;
import static mallang_trip.backend.domains.global.io.BaseResponseStatus.CANNOT_CHANGE_COURSE;
import static mallang_trip.backend.domains.global.io.BaseResponseStatus.CANNOT_FOUND_DRIVER;
import static mallang_trip.backend.domains.global.io.BaseResponseStatus.CANNOT_FOUND_PARTY;
import static mallang_trip.backend.domains.global.io.BaseResponseStatus.EXCEED_PARTY_CAPACITY;
...
import static mallang_trip.backend.domains.global.io.BaseResponseStatus.PARTY_CONFLICTED;
import static mallang_trip.backend.domains.global.io.BaseResponseStatus.PARTY_NOT_RECRUITING;
...
import mallang_trip.backend.domains.party.dto.CreatePartyRequest;
import mallang_trip.backend.domains.party.dto.JoinPartyRequest;
import mallang_trip.backend.domains.party.dto.PartyIdResponse;
...
import mallang_trip.backend.domains.driver.repository.DriverRepository;
...
import mallang_trip.backend.domains.reservation.service.ReservationService;
...
public class PartyService {
	...
	private void quitPartyBeforeReservationByLastMember(Party party) {
		...
		partyNotificationService.lastMemberQuit(userService.getCurrentUser(), party);
