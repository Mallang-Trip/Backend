...
public class DriverAdminService {
     ...
     * (관리자) 드라이버 신청
     */
    public void registerDriver(Long userId, List<String> region) {
        ...
        Driver driver = driverRepository.save(Driver.builder()
                .user(user)
                .region(region)
                .vehicleImgs(List.of("https://mallang-trip-db.s3.ap-northeast-2.amazonaws.com/profile/ed7ac840-86c5-4c14-a5cd-8d8761e080ff1.png"))
