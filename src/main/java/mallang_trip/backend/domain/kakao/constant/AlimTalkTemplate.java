...
public enum AlimTalkTemplate {
	...
	DRIVER_RESERVATION_CONFIRM("DriverReservationConfirm2",
		"[예약 확정 안내]\n"
			+ "예약이 확정되었습니다.\n"
			+ "\n"
			+ "- 파티명: #{party_name}\n"
	...
	DRIVER_RESERVATION_CANCELED("DriverReservationCanceled2",
		"[예약 취소 안내]\n"
		+ "예약이 취소되었습니다.\n"
		+ "\n"
		+ "- 파티명: #{party_name}\n"
	...
	DRIVER_NEW_PARTY("DriverNewParty2",
		"[여행 신청 안내]\n"
	...
	DRIVER_COURSE_CHANGE("DriverCourseChange2",
		"[변경 제안 안내]\n"
	...
	DRIVER_TRAVELER_LIST("DriverTravelerList2",
		"[예약자 명단 안내]\n"
			+ "#{driver_name} 드라이버님\n"
