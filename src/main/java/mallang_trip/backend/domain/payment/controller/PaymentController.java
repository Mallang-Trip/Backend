...
public class PaymentController {
	...
	@ApiOperation(value = "결제 재시도")
	@PostMapping("/{reservation_id}")
	@PreAuthorize("isAuthenticated()") // 로그인 사용자
	public BaseResponse<String> retryPayment(
		@PathVariable(value = "reservation_id") Long reservationId) throws BaseException {
		paymentService.retryPayment(reservationId);
		return new BaseResponse<>("성공");
	}
}
